...
Análise de cada método individualmente em diferentes cenários e comparar os resultados entre eles. Os métodos de identificação de colisão que serão analisados são \emph{OnTrigger}, \emph{OnCollision} e \emph{OnOverlap}.
%\begin{enumerate}
%\item dfsdsfd
%\item fwfsdfsd
%\end{enumerate}
