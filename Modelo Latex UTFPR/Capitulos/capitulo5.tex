...
Em relação as mensagens usadas, há uma distribuição equilibrada quando o uso é de início e final de contato com a colisão ou trigger, como mostra a Figura \ref{questionario_uso_mensagens_2d}. Já enquanto o contato ainda está ocorrendo é pouco utilizado.

O número médio de objetos numa cena podem ser encontrados na Figura \ref{questionario_media_2d}. Nesse resultado apenas dois participantes não responderam à pergunta.
