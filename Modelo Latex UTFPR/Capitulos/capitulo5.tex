...
\begin{figure}[!htb]
	...
	\caption[Gráfico dequantidade de Garbage Collection em bytes com 50 objetos Circle Collider em Pre-Runtime com física]{Gráfico de quantidade de \emph{Garbage Collection} em \emph{bytes} com 50 objetos \emph{Circle Collider} em \emph{Pre-Runtime} com física.}
