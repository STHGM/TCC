...
As medições incluirão taxa de quadros por segundo (FPS), taxa de consumo do processador, taxa de consumo de memória RAM, taxa de consumo da Unidade de Processamento Gráfico (GPU). Essas medições serão coletadas e analisadas posteriormente.
