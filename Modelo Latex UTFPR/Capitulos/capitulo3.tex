...
As medições incluirão taxa de quadros por segundo (FPS), taxa de consumo do processador, taxa de consumo de memória. Essas medições serão coletadas e analisadas posteriormente.
